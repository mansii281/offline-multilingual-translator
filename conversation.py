...
speech_model = WhisperModel("medium", compute_type="int8")
...
def select_language(person):
    ...
    while True:
        ...
        if choice in lang_menu:
            return lang_menu[choice]
        else:
            print("Invalid choice. Try again.")


langA = select_language("Person A")
langB = select_language("Person B")
